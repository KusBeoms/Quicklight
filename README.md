...
| 모든 앱 보기 | `앱`, `app`, `apps`, `application`, `애플리케이션`, `응용프로그램`, `프로그램` 을 입력하면 설치된 앱 전체를 이름순 그리드로 표시 (A–Z, ㄱ–ㅎ, # 구역. 제거 프로그램과 도움말 링크는 뺌). 뒤에 검색어를 붙이면 앱 안에서만 검색: `app apple music`, `app: apple music`, `app; apple music`, `app, apple music`, `앱 멜론` |
